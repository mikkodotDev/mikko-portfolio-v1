        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {services.map((service, index) => {
            return (
              ...
              >
                {/* Single Layer Card */}
                <div className="p-6 bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/30 hover:border-orange-400/50 rounded-2xl transition-all duration-300 h-full transform group-hover:shadow-lg group-hover:shadow-orange-500/20 cursor-pointer flex flex-col justify-between">
                  {/* Title */}
                  <div>
